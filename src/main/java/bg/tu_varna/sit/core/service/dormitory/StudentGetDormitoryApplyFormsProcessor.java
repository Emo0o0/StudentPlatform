    ...
    public StudentGetDormitoryApplyFormsListResponse process(StudentGetDormitoryApplyFormsRequest request) {
        ...
        return StudentGetDormitoryApplyFormsListResponse.builder()
                .forms(dormitoryApplyForms.stream()
                        .map(form -> StudentGetDormitoryApplyFormsResponse.builder()
                                ...
                                .keepRoomFormBuildingNumber(form.getKeepRoomForm() == null ? null : form.getKeepRoomForm().getBuildingNumber())
                                .keepRoomFormRoomNumber(form.getKeepRoomForm() == null ? null : form.getKeepRoomForm().getRoomNumber())
